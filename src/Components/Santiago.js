...
const Santiago = () => {
  ...
  const createChart = (chartElement, team) => {
    ...
    const margin = { top: 10, right: 10, bottom: 80, left: 60 }; // Reduced top margin from 40 to 10
  ...
  useEffect(() => {
    if (!chartRef.current || !overlayRef4.current.style.opacity) return;
  ...
  return (
    <div ref={sectionRef} style={{ height: '100vh', position: 'relative' }}>
      ...
      {/* OVERLAY 1: The Reign of Bernabéu */}
      ...
      {/* OVERLAY 2: Birth of European Championships */}
    ...
    <div style={{
      ...
      <div ref={overlayRef4} style={{
        ...
        <div style={{
          ...
          {/* MIDDLE COLUMN: Graphical Evidence of Terror */}
          <div style={{ 
            width: '40%',
            padding: '25px',
            paddingTop: '0px',
            ...
            {/* Combined legends and comparison selector in one row */}
            <div style={{
              display: 'flex',
